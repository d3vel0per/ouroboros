...
def _install_codex_default_llm_profiles(config_dict: dict) -> tuple[list[str], list[str]]:
    ...
    are preserved to avoid setup silently changing tuned user configurations.
    """
    ...
    return added_profiles, added_role_profiles
...
def _setup_codex(codex_path: str) -> None:
    ...
    added_profiles, added_role_profiles = _install_codex_default_llm_profiles(config_dict)
